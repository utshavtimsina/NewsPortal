...
function hitmag_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Right End Sidebar', 'hitmag' ),
        'id'            => 'footer-right-end',
        'description'   => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget'  => '</aside>',
...
function hitmag_scripts() {
    ...
    wp_enqueue_style( 'google_fonts', 'https://fonts.googleapis.com/css?family=Mukta:300,400,500,600,700&display=swap' ); 
    wp_enqueue_style( 'slick-style', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.css' );
    ...
    wp_enqueue_script( 'jquery-sticky', get_template_directory_uri() . '/js/jquery.sticky.js', array('jquery'), '201522', true );
    wp_enqueue_script( 'sidebar-sticky', get_template_directory_uri() . '/js/theia-sticky-sidebar.min.js', array('jquery'), '12345', true );
    wp_enqueue_script( 'resizesensor', get_template_directory_uri() . '/js/ResizeSensor.min.js', array('jquery'), '2345678', true );
    ...
    wp_enqueue_script( 'slickslider', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.js', array( 'jquery' ), '', true );
