...
class HitMag_Tabbed_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<ul class="hm-tab-nav">
			<li class="hm-tab"><a class="hm-tab-anchor" href="#hitmag-popular"><?php esc_html_e( 'लोकप्रिय', 'hitmag' ); ?></a></li>
			<li class="hm-tab"><a class="hm-tab-anchor" href="#hitmag-comments"><?php esc_html_e( 'प्रतिक्रियाहरु', 'hitmag' ); ?></a></li>
			<li class="hm-tab"><a class="hm-tab-anchor" href="#hitmag-tags"><?php esc_html_e( 'ट्यागहरू', 'hitmag' ); ?></a></li>
		</ul>
